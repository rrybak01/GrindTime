...
export default function Register({ navigation }) {
    ...
    const postUsuario = async (usuario, email, contraseña) => {
        try {
                ...
                if (email !== "") {
                    if (contraseña !== "") {
                        usuarios.map((item) => {
                            ...
                            if (email !== item.email) {
                                postUsuario(usuario, email, contraseña);
                            } else {
            ...
            <ScrollView style={styles.scrollView}>
                <View style={[styles.content]}>
                    <View style={[styles.box]}>
                        ...
                        <TextInput style={[styles.userInput]} placeholderTextColor="black" onChangeText={email => changeEmail(email)} />
                    ...
                    <TouchableHighlight underlayColor='#102739' style={[styles.loginButton]} onPress={() => register()}>
